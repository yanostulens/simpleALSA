...
/** Define the SA_IMPLEMENTATION macro in the file where you want to use simpleALSA.h
 *  Do this at the absolute top of the file!
 */
...
/** Download and include the simpleALSA header */
